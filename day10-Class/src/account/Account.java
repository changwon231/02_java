...
public class Account {
	...
	/**
	 * 계좌 잔액만 전달받고, 계좌번호는 클래스 변수인 count가 값이 유지되는 특징을 
	 * 사용하여 증가되는 일련번호로 직접 적용하여 계좌 객체를 생성하는 생성자
	 * 
	 * @param balance
	 */
	Account(int balance)	{
//		this.accNumber = ++cnt;
	 ...
	 * @param newBlance
	 */
	Account(String strAccNumber, int newBlance){
	 ...
	 * 출금이 성공하면
	 * "얼마 .... 가 출금되었습니다. 잔액은 ... 입니다."  라는
	 * 문자열을 리턴한다.
	 * 
	 * @param amount : int 출금하려는 금액
	 */
	public String withdraw(int amount) {
		String result = "잔액이 부족합니다.\n";
		if (amount < balance) {
			balance -= amount;
			result = accNumber + "계좌에서" + amount + "원이 출금되었습니다. 잔액은" + balance +" 입니다.\n";
		}
		return result;
	}
}
