...
public class TernaryTest {
	public static void main(String[] args) {
		...
		//3.  사용 : 출력
		System.out.printf("x = %d 일 때, x 절댓값은 %d%n", x,absX);
		System.out.printf("y = %d 일 때, y 절댓값은 %d%n", y,absY);
		...
		absZ = (z >= 0) ? z : -z;
		System.out.printf("z = %d 일때, z의 절대값은 %d%n",z ,absZ);
